class TutorialManager {
        ...
        switch (this.currentStep) {
            ...
            default: 
                return { 
                    ...
                    desc: "You have completed the tutorial!" 
                };
        }
    }
    ...
    getCurrentPrompt() {
        switch (this.currentStep) {
            case 1: 
                return "Use WASD to move to the yellow zone";
            case 2: 
                return `Press SPACE to toss, then press again to hit at the right height (${this.successCount}/${this.targetCount})`;
            case 3: 
                return `Press SPACE to return the AI's serve (${this.successCount}/${this.targetCount})`;
            case 4: 
                return `Wait for the serve, press Q to CHARGE, then HIT! (${this.successCount}/${this.targetCount})`;
            case 5: 
                return `Score 3 points (${this.successCount}/${this.targetCount})`;
            default: 
                return "";
        }
    }
